...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "tblAccess"
  MM_editColumn = "ID"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "main.asp"
  MM_fieldsStr  = "txtUser|value|txtPass|value"
...
rsUser.ActiveConnection = MM_dreamConn_STRING
rsUser.Source = "SELECT * FROM tblAccess WHERE Username = '" + Replace(rsUser__MMColParam, "'", "''") + "'"
rsUser.CursorType = 0
...
<td valign="top"> 
<form action="<%=MM_editAction%>" method="POST" name="form1" onSubmit="YY_checkform('form1','txtUser','#q','0','Field \'txtUser\' is not valid.','txtPass','#q','0','Field \'txtPass\' is not valid.','txtConfirm','txtPass','6','Passwords do not match');return document.MM_returnValue">

<table width="100%"  border="0">

<tr> 
<td align="right">User Name</td>
<td><%=Session("MM_Username")%></td>
</tr>
<tr> 
<td align="right">Old Password</td>
<td> <%=(rsUser.Fields.Item("Password").Value)%></td>
</tr>
<tr> 
